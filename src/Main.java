        ...
        try {
            ...
            while (myReader.hasNextLine()) {
                ...
                if (!line.isEmpty()) {
                    ...
                    IListeDoublementChainee ldc = new ListeDoublementChainee(sens);

                    /**
                     * Cette fonction doit ajouter tous les elements d'une liste en string
                     * dans la liste doublement chainee. Vous devez recuperer chaque element de la liste
                     * et utiliser le bon cast sur celui-ci pour ensuite pouvoir comparer les differents
                     * types.
                    ...
                    /**
                     * Ces fonctions impriment du début vers la fin, ou de la fin vers le début
                     * le contenu de la liste doublement chainée avec le format présenté dans l'énoncé.
                     * @param  listeEnString   Exemple: '[1,2,3]'
                     */
